...
<body>
  <div class="shell">
    ...
    <main>
      ...
      <section class="grid">
        <article class="card"><div class="card-title"><h2>Generated Weekly Report Link</h2></div><div class="sections"><section class="box"><h3>Weekly Market Events Report</h3><p>Open the generated weekly market-events report from the Baybell report publisher.</p><div class="actions"><a class="button primary" href="${escapeHtml(weeklyReportUrl)}" target="_blank" rel="noreferrer">Open Latest Weekly Report</a><a class="button" href="https://github.com/awolf08/reports/tree/main/weekly-finance" target="_blank" rel="noreferrer">Open Report Archive</a></div></section><section class="box"><h3>How This Fits</h3><p>Use this link for the full weekly generated report. The cards below remain the Baybell data-driven weekly dashboard view.</p></section></div></article>
